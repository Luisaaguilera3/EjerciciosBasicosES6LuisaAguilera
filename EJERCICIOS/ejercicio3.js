...
const copyPointsList =[...pointList];
...
const sumPointLists =[...pointList, ...pointsLis2];
console.log(sumPointLists);
...
const newcColorsCopy = [...colors.slice(0,2), ...colors.slice(3)];
console.log(newcColorsCopy);